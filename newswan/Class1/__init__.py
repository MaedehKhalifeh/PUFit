...
#             legend_title="param = Cross Section",
#         )    
...
#             title = 
        ...
        if g is None:
            ...
            g.update_layout(height=(self.nLumiBins+3)*400, width=1200, title_text="Best fit & NLL values for Cross Section" , legend_title="Runs",)
        #runInfo:    
